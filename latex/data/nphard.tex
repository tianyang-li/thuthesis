...
我们下面将用 unary 输入的 3-PARTITION 在多项式时间内规约到 M-ISOFORM. 

给定一个 unary 输入的 3-PARTITION 的实例, 我们构造一个基因如图 \ref{tripart-reduce-gene} 所示. 

\begin{figure}[!t]
\centering
\includegraphics[height=\textheight]{figures/nphard/part3-gene.pdf}
